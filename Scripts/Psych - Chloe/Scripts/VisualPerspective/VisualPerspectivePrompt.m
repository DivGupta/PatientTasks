function name = VisualPerspectivePrompt
%-------------------------IMPORTANT---------------------------------
...
% directory = 'C:\Documents and Settings\ASD Lab\My Documents\MATLAB\Visual Perspective Taking Task\Right_handed\M_version';
% cd(directory);
...
if ~exited
    ...
    VisualPerspectiveTask(name, blocks, answers)
end
